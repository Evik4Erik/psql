...
ALTER DEFAULT PRIVILEGES FOR ROLE app_user IN SCHEMA catalog GRANT ALL ON TABLES TO catalog_manager;
ALTER DEFAULT PRIVILEGES FOR ROLE app_user IN SCHEMA sales GRANT ALL ON TABLES TO sales_manager;
